...
public class MqttCodecTest {
    ...
    private static MqttSubAckMessage createSubAckMessage() {
        ...
        MqttPacketIdVariableHeader mqttPacketIdVariableHeader = MqttPacketIdVariableHeader.from(12345);
        MqttSubAckPayload mqttSubAckPayload = new MqttSubAckPayload(MqttSubAckReturnCode.SUCCESS_MAX_QOS1, MqttSubAckReturnCode.SUCCESS_MAX_QOS2, MqttSubAckReturnCode.SUCCESS_MAX_QOS0);
